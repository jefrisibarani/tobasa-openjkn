...
/*
   DataContextAntrian, the base data context,
   we use one generated/scaffolded from MSSQL
*/
...
{
    public partial class DataContextAntrian : DbContext
    {
        protected readonly IConfiguration _configuration;

        ValueConverter DateOnlyConverter = new ValueConverter<DateOnly, DateTime>(
            d => d.ToDateTime(TimeOnly.MinValue),  // DateOnly → DateTime
            dt => DateOnly.FromDateTime(dt)        // DateTime → DateOnly
        );

        public DataContextAntrian(IConfiguration configuration)
        {
        ...
        public virtual DbSet<BaseRoles> BaseRoles { get; set; } = null!;
        public virtual DbSet<BaseSites> BaseSites { get; set; } = null!;
        public virtual DbSet<BaseUserRole> BaseUserRole { get; set; } = null!;
        public virtual DbSet<BaseUserSite> BaseUserSite { get; set; } = null!;
        public virtual DbSet<BaseUsers> BaseUsers { get; set; } = null!;
        public virtual DbSet<BlAntrian> BlAntrian { get; set; } = null!;
        public virtual DbSet<BlAntrianStatusHistory> BlAntrianStatusHistory { get; set; } = null!;
        public virtual DbSet<BlDokter> BlDokter { get; set; } = null!;
        public virtual DbSet<BlIdGen> BlIdGen { get; set; } = null!;
        public virtual DbSet<BlJadwal> BlJadwal { get; set; } = null!;
        public virtual DbSet<BlJadwalBedah> BlJadwalBedah { get; set; } = null!;
        public virtual DbSet<BlPasien> BlPasien { get; set; } = null!;
        public virtual DbSet<BlPoli> BlPoli { get; set; } = null!;
        public virtual DbSet<MjknAmbilAntrian> MjknAmbilAntrian { get; set; } = null!;
        public virtual DbSet<MjknAntrianTransaction> MjknAntrianTransaction { get; set; } = null!;
        public virtual DbSet<MjknDokter> MjknDokter { get; set; } = null!;
        public virtual DbSet<MjknJadwalDokter> MjknJadwalDokter { get; set; } = null!;
        public virtual DbSet<MjknPasien> MjknPasien { get; set; } = null!;
        public virtual DbSet<MjknPoli> MjknPoli { get; set; } = null!;
        public virtual DbSet<MjknPoliSub> MjknPoliSub { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BaseUserRole>(entity =>
            {
                ...
                entity.HasOne(d => d.Role)
                    ...
                    .HasConstraintName("FK_base_user_role_base_user_role");
            ...
            modelBuilder.Entity<BaseUsers>(entity =>
            {
                ...
                entity.HasIndex(e => e.UserName, "UQ__base_use__7C9273C4CC199DC7")
                    .IsUnique();

                entity.HasIndex(e => e.Uuid, "UQ__base_use__7F427931BD7C94EE")
                    .IsUnique();
                ...
                entity.Property(e => e.Expired)
                    ...
                    .HasDefaultValueSql("(dateadd(year,(4),getdate()))");
            ...
            modelBuilder.Entity<BlDokter>(entity =>
            {
                entity.HasKey(e => e.KodeDokter)
                    .HasName("PK__bl_dokte__C3C267C38451EE4F");
            ...
            modelBuilder.Entity<BlIdGen>(entity =>
            {
                entity.HasKey(e => e.KodeFaskes)
                    .HasName("PK__bl_id_ge__FA22CE0F890BE9E4");
            ...
            modelBuilder.Entity<BlJadwal>(entity =>
            {
                ...
                entity.HasIndex(e => e.KodeJadwal, "UQ__bl_jadwa__27217F769348C77A")
                    .IsUnique();
            ...
            modelBuilder.Entity<BlJadwalBedah>(entity =>
            {
                entity.HasKey(e => e.NomorJadwal)
                    .HasName("PK__bl_jadwa__0B21CEB13A9D0A59");
            ...
            modelBuilder.Entity<BlPasien>(entity =>
            {
                entity.HasKey(e => e.NomorRekamMedis)
                    .HasName("PK__bl_pasie__7B16F3336EA6562E");
            ...
            modelBuilder.Entity<BlPoli>(entity =>
            {
                entity.HasKey(e => e.KodePoli)
                    .HasName("PK__bl_poli__3CEA9C4E943DCEFB");
            ...
            modelBuilder.Entity<MjknDokter>(entity =>
            {
                ...
                entity.HasIndex(e => e.KodedokterJkn, "UQ__mjkn_dok__CBD1B0D76FED7F47")
                    .IsUnique();
            ...
            modelBuilder.Entity<MjknPasien>(entity =>
            {
                ...
                entity.HasIndex(e => e.NomorKartu, "UQ__mjkn_pas__C1B4ED5B2D711A1C")
                    .IsUnique();
            ...
            modelBuilder.Entity<MjknPoli>(entity =>
            {
                ...
                entity.HasIndex(e => e.Kode, "UQ__mjkn_pol__25A8749283BA36F4")
                    .IsUnique();
            ...
            modelBuilder.Entity<MjknPoliSub>(entity =>
            {
                ...
                entity.HasIndex(e => e.Kode, "UQ__mjkn_pol__25A8749277EC895A")
                    .IsUnique();
