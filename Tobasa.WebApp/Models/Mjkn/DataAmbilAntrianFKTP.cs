...
{
    public class DataAmbilAntrianFKTP
    {
        public DataAmbilAntrianFKTP()
        {
            JenisPasien     = "";
            AppSource       = "";
            Nik             = "";
        ...
        public DataAmbilAntrianFKTP(RequestAmbilAntrianSimrs request)
        {
            ...
            NomorReferensi  = "";
            JenisKunjungan  = -1;
			Keluhan         = "";  // khusus FKTP/Tidak perlu bila dari simrs request
        }

        public DataAmbilAntrianFKTP(RequestAmbilAntrianFKTP request)
        {
            ...
            NomorReferensi  = "";
            JenisKunjungan  = -1;
			Keluhan         = request.Keluhan;  // khusus FKTP
        }
    ...
    public class ResultAmbilAntrianFKTP
    {
        public ResultAmbilAntrianFKTP()
        {
            RegistrationToken = "";
            IssuedAt          = "";
            AngkaAntrian      = -1;
        ...
        public ResultAmbilAntrianFKTP(string message)
        {
            RegistrationToken = "";
            IssuedAt          = "";
            AngkaAntrian      = -1;
